...
pipeline {
    ...
    environment {
        PROJECT_PATH = "D:\\Slot-Crazy777"
        S3_BUCKET = "crazy777bucket"
    }
        ...
        stage('Checkout') {
            steps {
                script {
                    ...
                    git clone git@github.com:DingDingHouse/Slot-Crazy777.git D:\\Slot-Crazy777 || echo "Repository already exists, pulling latest changes."
                    cd Slot-Crazy777
                    git fetch --all
